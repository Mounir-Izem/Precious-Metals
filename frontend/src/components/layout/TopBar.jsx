        ...
        <header className="flex justify-between items-center px-4 py-3 bg-white">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className={`rounded-full px-3 py-1 text-sm ${language === 'fr' ? 'border-2 border-yellow-700' : 'border border-gray-400'}`}
                    aria-label="Français">
                    <img src="/flags/fr.svg" alt="Français" className="w-6 h-4" />
                </button>
                <button
                    onClick={() => { i18n.changeLanguage('en'); setLanguage('en'); }}
                    className={`rounded-full px-3 py-1 text-sm ${language === 'en' ? 'border-2 border-yellow-700' : 'border border-gray-400'}`}
                    aria-label="English">
